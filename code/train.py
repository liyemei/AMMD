...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    if RANK in [-1, 0]:
        ...
        if not resume:
            ...
            writer = pandas.ExcelWriter('save/train_label.xlsx')
...
def parse_opt(known=False):
    ...
    parser.add_argument('--imgsz', nargs='+', type=int, default=1280, help='[train, test] image sizes')
    parser.add_argument('--rect', action='store_true',default=False,help='rectangular training')
    parser.add_argument('--resume', nargs='?', const=True, default=0, help='resume most recent training')
    parser.add_argument('--nosave', action='store_true', help='only save final checkpoint')
    parser.add_argument('--noval', action='store_true', help='only test final epoch')
    ...
    parser.add_argument('--project', default='../results/runs', help='save to project/name')
    ...
    parser.add_argument('--patience', type=int, default=6000, help='EarlyStopping patience (epochs without improvement)')
